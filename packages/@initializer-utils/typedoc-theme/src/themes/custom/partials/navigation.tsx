...
import { partition } from 'typedoc/dist/lib/utils/array';
import type { CustomThemeRenderContext } from '../CustomThemeRenderContext';

export function navigation(context: CustomThemeRenderContext, props: PageEvent<Reflection>) {
  return (
    <>
...
function primaryNavigation(context: CustomThemeRenderContext, props: PageEvent<Reflection>) {
...
function secondaryNavigation(context: CustomThemeRenderContext, props: PageEvent<Reflection>) {
